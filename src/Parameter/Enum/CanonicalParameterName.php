...
final class CanonicalParameterName
{
    ...
    /**
     * Идентификатор заказа в системе Merchant, соответствующий данному платежу.
     */
     ...
     */
    const S_FIELDS = 'SFields';

    /**
     * Номер платежа в системе Uniteller (Retrieval Reference Number).
     * 12 цифр.
     */
     ...
     */
    const PARENT_SHOP_ID = 'ParentShopId';
